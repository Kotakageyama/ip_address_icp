          ...
          <div className="secure-features">
            <div className="feature-grid">
              ...
              <div className="feature-item">
                ...
                <span className="feature-text">プライバシー保護</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">✅</span>
                <span className="feature-text">セキュア接続</span>
              </div>
              <div className="feature-item">
                <span className="feature-icon">🎯</span>
                <span className="feature-text">位置情報保護</span>
              </div>
            </div>
          </div>
    ...
    <section className="current-visitor">
      ...
      <div className="visitor-info-card leak-detection-card">
        <div className="security-status">
          ...
          >
            <span className="security-icon">{securityLevel.icon}</span>
            <span className="security-text">
        ...
        <div className="visitor-info-grid">
          <div className="visitor-info-item critical">
            <div className="visitor-info-label">🚨 漏洩したIPアドレス</div>
            <div className="visitor-info-value ip-address">{currentIp}</div>
          </div>
          <div className="visitor-info-item">
            <div className="visitor-info-label">🌍 推定国</div>
            <div className="visitor-info-value">{ipInfo.country}</div>
          </div>
          <div className="visitor-info-item">
            <div className="visitor-info-label">📍 推定地域</div>
            <div className="visitor-info-value">{ipInfo.region}</div>
          </div>
          <div className="visitor-info-item">
          ...
          <div className="visitor-info-item">
            ...
            <div className="visitor-info-value">{ipInfo.timezone}</div>
          </div>
          <div className="visitor-info-item">
